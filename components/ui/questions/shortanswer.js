...
export default function CFCShortAnswer(props) { //props = {question}
  ...
  const updateInputHelper = (event) => {
    ...
    return (
      <Fragment>
          ...
          <CFCSmallTextField input={val} autoFocus={true} updateInputHelper={updateInputHelper} inputRef={props.inputRef}></CFCSmallTextField>
      </Fragment>
    )
}