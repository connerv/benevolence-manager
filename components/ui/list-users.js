...
function Alert(props) {
  ...
  const headCells = [
    ...
    { id: 'type', numeric: false, disablePadding: false, label: 'User Type' },
    ...
    { id: 'lock', numeric: false, disablePadding: false, label: 'Lock Account' },
  ];
...
export default function ListUsers({users, setUsers, resetData}) {
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{changeNameToUser(row.data.permissions)}</TableCell>
                       ...
                       <div id={row.id} onClick={() => {handleSendLink(row.id,row.data.email)}}>
                        ...
                        <TableCell align="left">
                          {row.data.accountLocked ? (
                            <Lock style={{ color: red[500] }}></Lock>
                          ) : (
                            <div id={row.id} onClick={handleLockAccount}>
                            <Button variant="outlined" size="small" color="primary" aria-label="Lock Account" id={row.id}>
                                Lock Account
                            </Button>
                            </div>
                          )}
