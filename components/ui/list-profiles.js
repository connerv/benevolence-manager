...
import EditChurchResponse from "./edit-church-response";
  ...
  function XTableRow({ row, index, handleOpenProfile, deacons, resetData, handleEditAnswers, handleEditQuestions, handleBudget, handleChurchResponse }){
    ...
    const assignStatus = async (id) => {
      let thisStatus = status
      console.log(id, thisStatus)
      await changeFileStatus(id, thisStatus)
      setStatus("active")
      resetData()
        ...
        <React.Fragment>
            ...
            <TableRow>
                ...
                <Collapse in={open} timeout="auto" unmountOnExit>
                    ...
                    <TableRow>
                    <FormControl className={classes.formControl}>
                      <InputLabel id="demo-simple-select-label">Deacon</InputLabel>
                      <Select
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        onChange={handleDeaconChange}
                        value={deacon}
                      >
                        {deacons.map((d) => {
                          return(
...
export default function ListProfiles({users, setUsers, questions, fullQuestions, deacons, resetData}) {
            ...
            >
              ...
              <TableBody>
                {stableSort(rows, getComparator(order, orderBy), getSearchTerm(searchTerm))
                  ...
                  .map((row, index) => {
                      return(
                        <XTableRow key={index} row={row} index={index} deacons={deacons} handleOpenProfile={handleOpenProfile} handleChurchResponse={handleChurchResponse} handleBudget={handleBudget} handleEditQuestions={handleEditQuestions} handleEditAnswers={handleEditAnswers} resetData={resetData} />
                      );      
